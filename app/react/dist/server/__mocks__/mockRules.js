...
var _default = [{
  ...
  oneOf: [{
    ...
    options: {
      ...
      cacheIdentifier: 'development:babel-plugin-named-asset-import@0.2.3:babel-preset-react-app@6.1.0:react-dev-utils@6.1.1:react-scripts@',
      plugins: [['/mock_folder/node_modules/babel-plugin-named-asset-import/index.js', {
        loaderMap: {
          svg: {
    ...
    options: {
      ...
      configFile: false,
      compact: false,
      presets: [['/mock_folder/node_modules/babel-preset-react-app/dependencies.js', {
        helpers: true
      }]],
      cacheDirectory: true,
      cacheCompression: false,
    ...
    test: /\.css$/,
    exclude: {},
    use: ['/mock_folder/node_modules/bmr-react-scripts/node_modules/style-loader/index.js', {

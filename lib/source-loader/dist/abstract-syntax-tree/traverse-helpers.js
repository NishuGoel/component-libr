...
function findStoryTitle(storyVar, ast) {
  const titleAssignment = ast.program.body.find(d => d.type === 'ExpressionStatement' && d.expression && d.expression.type === 'AssignmentExpression' && d.expression.left && d.expression.left.type === 'MemberExpression' && d.expression.left.object && d.expression.left.object.type === 'Identifier' && d.expression.left.object.name === storyVar && d.expression.left.property.type === 'Identifier' && d.expression.left.property.name === 'story' && d.expression.right && d.expression.right.type === 'ObjectExpression');
  const nameProp = titleAssignment && titleAssignment.expression.right.properties.find(prop => prop.key.type === 'Identifier' && prop.key.name === 'name' && prop.value.type === 'StringLiteral');

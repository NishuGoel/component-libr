...
function (_Component) {
  ...
  function ActionLogger(props) {
    ...
    _this.channel = _addons.addons.getChannel();
  ...
  _createClass(ActionLogger, [{
    ...
    value: function componentDidMount() {
      this.channel.addListener(_addonActions.EVENT_ID, this.addAction);
      this.channel.addListener(_coreEvents.STORY_RENDERED, this.handleStoryChange);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      this.channel.removeListener(_coreEvents.STORY_RENDERED, this.handleStoryChange);
      this.channel.removeListener(_addonActions.EVENT_ID, this.addAction);
    }
  }, {
    key: "render",
